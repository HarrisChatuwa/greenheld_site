...
<header class="bg-white shadow-md sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav class="hidden md:flex space-x-1 items-center">
            <a href="index.php" id="nav-home" class="py-2 px-3 text-neutral-default hover:text-primary hover:bg-neutral-light rounded-md transition-all duration-300">Home</a>
            <a href="about.php" id="nav-about" class="py-2 px-3 text-neutral-default hover:text-primary hover:bg-neutral-light rounded-md transition-all duration-300">About</a>
            <a href="services.html" id="nav-services" class="py-2 px-3 text-neutral-default hover:text-primary hover:bg-neutral-light rounded-md transition-all duration-300">Services</a>
            <a href="projects.php" id="nav-projects" class="py-2 px-3 text-neutral-default hover:text-primary hover:bg-neutral-light rounded-md transition-all duration-300">Projects</a>
            <a href="testimonials.php" id="nav-testimonials" class="py-2 px-3 text-neutral-default hover:text-primary hover:bg-neutral-light rounded-md transition-all duration-300">Testimonials</a>
            <a href="contact.html" id="nav-contact" class="bg-primary hover:bg-primary-dark text-white font-semibold py-2 px-4 rounded-md transition-all duration-300">Contact Us</a>
        </nav>
        <div class="md:hidden">
    ...
    <div id="mobile-menu" class="md:hidden hidden bg-white shadow-lg py-2">
        <a href="index.php" id="nav-home-mobile" class="block px-4 py-2 text-neutral-default hover:bg-primary-light hover:text-primary-dark transition duration-300">Home</a>
        <a href="about.php" id="nav-about-mobile" class="block px-4 py-2 text-neutral-default hover:bg-primary-light hover:text-primary-dark transition duration-300">About</a>
        <a href="services.html" id="nav-services-mobile" class="block px-4 py-2 text-neutral-default hover:bg-primary-light hover:text-primary-dark transition duration-300">Services</a>
        <a href="projects.php" id="nav-projects-mobile" class="block px-4 py-2 text-neutral-default hover:bg-primary-light hover:text-primary-dark transition duration-300">Projects</a>
        <a href="testimonials.php" id="nav-testimonials-mobile" class="block px-4 py-2 text-neutral-default hover:bg-primary-light hover:text-primary-dark transition duration-300">Testimonials</a>
        <a href="contact.html" id="nav-contact-mobile" class="block px-4 py-2 text-neutral-default hover:bg-primary-light hover:text-primary-dark transition duration-300">Contact Us</a>
    </div>
</header>
    ...
    <main class="py-16 md:py-24 bg-white">
        <div class="container mx-auto px-6 md:px-12">
            ...
            <section id="mission-vision" class="mb-12 md:mb-16 p-8 bg-neutral-light rounded-xl shadow-lg">
                <h2 class="text-3xl font-semibold text-primary-dark mb-8 text-center">Our Mission & Vision</h2>
                <div class="grid md:grid-cols-2 gap-10">
                    <div>
                        <h3 class="text-2xl font-medium text-primary mb-4 flex items-center">
                            <svg class="w-6 h-6 mr-2 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
                            Mission
                        </h3>
                        <p class="text-neutral-default leading-relaxed">
                            To empower NGOs, government bodies, and private enterprises with rigorous, insightful social research and strategic consulting. We enable our partners to make evidence-based decisions that foster positive social impact, promote equity, and contribute to sustainable development within communities across Malawi and beyond.
                        </p>
                    </div>
                    <div>
                        <h3 class="text-2xl font-medium text-primary mb-4 flex items-center">
                             <svg class="w-6 h-6 mr-2 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg>
                            Vision
                        </h3>
                        <p class="text-neutral-default leading-relaxed">
                            To be the leading and most trusted partner in social research and consulting in Southern Africa, recognized for our unwavering commitment to methodological excellence, ethical practices, collaborative partnerships, and the tangible advancement of social well-being and equitable progress for all.
                        </p>
                    </div>
                </div>
            </section>

            <section id="values" class="mb-12 md:mb-16 p-8 bg-white rounded-xl shadow-lg border border-neutral-200">
                <h2 class="text-3xl font-semibold text-primary-dark mb-8 text-center">Our Core Values</h2>
                <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
                    <div class="p-6 bg-neutral-light rounded-lg transition-transform transform hover:scale-105">
                        <div class="flex justify-center mb-4">
                            <svg class="w-12 h-12 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15l-3.712 3.712A7.5 7.5 0 013 12V5.25a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 5.25V12a7.5 7.5 0 01-7.288 7.463L12 15z"></path></svg>
                        </div>
                        <h3 class="text-xl font-semibold text-accent mb-2">Integrity</h3>
                        <p class="text-neutral-default text-sm leading-relaxed">Upholding the highest ethical standards, ensuring transparency and honesty in all our research processes and client interactions.</p>
                    </div>
                    <div class="p-6 bg-neutral-light rounded-lg transition-transform transform hover:scale-105">
                        <div class="flex justify-center mb-4">
                            <svg class="w-12 h-12 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"></path></svg>
                        </div>
                        <h3 class="text-xl font-semibold text-accent mb-2">Excellence</h3>
                        <p class="text-neutral-default text-sm leading-relaxed">Striving for methodological rigor, innovation, and the delivery of high-quality, actionable insights in every project we undertake.</p>
                    </div>
                    <div class="p-6 bg-neutral-light rounded-lg transition-transform transform hover:scale-105">
                        <div class="flex justify-center mb-4">
                            <svg class="w-12 h-12 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.653-.125-1.273-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.653.125-1.273.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                        </div>
                        <h3 class="text-xl font-semibold text-accent mb-2">Collaboration</h3>
                        <p class="text-neutral-default text-sm leading-relaxed">Working closely and respectfully with clients, communities, and stakeholders to co-create knowledge and achieve shared goals.</p>
                    </div>
                    <div class="p-6 bg-neutral-light rounded-lg transition-transform transform hover:scale-105">
                        <div class="flex justify-center mb-4">
                            <svg class="w-12 h-12 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg>
                        </div>
                        <h3 class="text-xl font-semibold text-accent mb-2">Impact</h3>
                        <p class="text-neutral-default text-sm leading-relaxed">Focusing our efforts on research that leads to tangible, positive change, informs policy, and improves lives within society.</p>
                    </div>
                </div>
            </section>
            ...
            <!-- <section id="approach" class="mb-12 md:mb-16 p-8 bg-neutral-light rounded-xl shadow-lg">
                ...
                <div class="grid md:grid-cols-2 gap-10 items-center">
                    <div class="md:order-2">
                        <img src="https://picsum.photos/seed/approach/600/400" alt="Our Approach" class="rounded-lg shadow-md w-full h-auto object-cover">
                    </div>
                    <div class="md:order-1">
                        <p class="text-neutral-default leading-relaxed text-lg">
