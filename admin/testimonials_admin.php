...
try {
    $stmt = $pdo->query("SELECT id, LEFT(quote, 150) AS quote_snippet, client_name, client_title_company, client_photo_url, created_at FROM greefrot_greenheld.testimonials ORDER BY created_at DESC");
