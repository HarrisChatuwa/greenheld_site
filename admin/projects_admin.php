...
<body class="bg-gray-100 font-sans antialiased">
    <div class="flex h-screen">
        ...
        <main class="flex-1 p-8 overflow-y-auto main-content">
            ...
            <section id="add-project-form" class="mb-8 bg-white p-6 rounded-lg shadow-md">
                ...
                <form action="process_project.php" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="title" name="title" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm form-input">
                    </div>

                    <div>
                        <label for="description" class="block text-sm font-medium text-gray-700">Description <span class="text-red-500">*</span></label>
                        <textarea id="description" name="description" rows="4" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm form-input"></textarea>
                    </div>

                    <div>
                        <label for="outcome" class="block text-sm font-medium text-gray-700">Key Outcome/Impact</label>
                        <textarea id="outcome" name="outcome" rows="3" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm form-input"></textarea>
                    </div>

                    <div>
                        <label for="image" class="block text-sm font-medium text-gray-700">Project Image <span class="text-red-500">*</span></label>
                        <input type="file" id="image" name="image" required accept="image/jpeg, image/png, image/gif" class="mt-1 block w-full text-sm text-gray-500
                        ...
                        ">
                        <p class="mt-1 text-xs text-gray-500">Accepted formats: JPG, PNG, GIF. Max size: 2MB (example).</p>
                    </div>
            ...
            <section id="display-projects" class="bg-white p-6 rounded-lg shadow-md">
                <h2 class="text-2xl font-semibold text-gray-800 mb-4">Existing Projects</h2>
                <?php if (empty($projects) && !isset($fetch_error)): ?>
                    <p class="text-gray-600">No projects found. Add one using the form above.</p>
