<aside id="sidebar" class="bg-gray-800 text-white w-64 h-full fixed top-0 left-0 z-50 transform -translate-x-full transition-transform duration-300 ease-in-out md:relative md:translate-x-0 md:flex-shrink-0">
    ...
    <nav>
        <ul class="nav-links">
            <li class="p-4 hover:bg-gray-700"><a href="index.php" id="nav-dashboard" class="flex items-center">
            ...
            <li class="p-4 hover:bg-gray-700"><a href="submissions.php" id="nav-submissions" class="flex items-center">
            ...
            <li class="p-4 hover:bg-gray-700"><a href="projects.php" id="nav-projects" class="flex items-center">
            ...
            <li class="p-4 hover:bg-gray-700"><a href="testimonials.php" id="nav-testimonials" class="flex items-center">
                <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg>
                Testimonials
            </a></li>
            <li class="p-4 hover:bg-gray-700"><a href="users.php" id="nav-users" class="flex items-center">
            ...
            <li class="p-4 hover:bg-gray-700"><a href="team.php" id="nav-team" class="flex items-center">
...
<div class="flex-1 flex flex-col overflow-hidden">
    <header class="bg-white shadow p-4 flex justify-between items-center md:hidden">
        <button id="open-sidebar" class="text-gray-500">
